    ...
    <div ref={containerRef} className="relative bg-black min-h-screen">
      ...
      <nav
        className={`fixed top-0 left-0 w-full z-40 transition-all duration-500
          ${scrolled ? "backdrop-blur-lg bg-black/40 border-white/10" : "bg-transparent"}`}
      >
        ...
        <motion.div
          ...
          className="overflow-hidden md:hidden backdrop-blur-lg bg-black/90 border-t border-white/10"
        >
          <div className="flex flex-col items-center gap-6 py-8 text-sm tracking-widest text-white/80">
            <a href="#projects" onClick={handleNavClick} className="hover:text-gold transition-colors">PROJECTS</a>
            <a href="https://drive.google.com/file/d/1_WDfuUd2HhlhT5v9IP0f90TQ8kBzaJUR/view?usp=sharing" target="_blank" rel="noreferrer" onClick={handleNavClick} className="hover:text-gold transition-colors">RESUME</a>
            <a href="#about" onClick={handleNavClick} className="hover:text-gold transition-colors">ABOUT</a>
            <a href="#contact" onClick={handleNavClick} className="hover:text-gold transition-colors">CONTACT</a>
          </div>
        </motion.div>
      </nav>
      ...
      <section id="hero" className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-6">
          <h1 className="font-serif text-5xl sm:text-7xl md:text-8xl lg:text-9xl font-bold tracking-tighter leading-none mb-4">
          ...
          <motion.div
            ...
            className="mt-8 md:mt-12 flex items-center justify-center gap-3 md:gap-4"
          >
            <div className="h-[1px] w-8 md:w-12 bg-gold" />
            <p className="text-base md:text-xl lg:text-2xl font-light tracking-widest text-white/80">UI / UX DESIGNER</p>
            <div className="h-[1px] w-8 md:w-12 bg-gold" />
          </motion.div>
        </div>
        ...
        >
          ...
          <div className="w-[1px] h-10 md:h-12 bg-gradient-to-b from-gold to-transparent" />
        </motion.div>
      </section>

      {/* ── Projects Section ── */}
      <section id="projects" className="py-20 md:py-32 px-6 md:px-12 lg:px-24 bg-dark-gray relative z-20">
        <div className="max-w-7xl mx-auto">
          <div className="mb-16 md:mb-24">
            <TextReveal text="WORK THAT I'M PROUD OF" className="font-serif text-3xl md:text-5xl lg:text-6xl text-white" />
            <div className="w-16 md:w-24 h-[2px] bg-gold mt-6 md:mt-8" />
          </div>
            ...
            {projects.map((project, index) => (
              ...
              >
                ...
                <div className="w-full md:w-2/5 flex flex-col justify-center">
                  <span className="text-gold tracking-widest text-sm mb-3 block">{project.category}</span>
                  <h3 className="font-serif text-3xl md:text-4xl lg:text-5xl mb-6 md:mb-8 text-white group-hover:text-gold transition-colors duration-300">
                    {project.title}
                  </h3>
      ...
      {/* ── About Section ── */}
      <section id="about" className="py-20 md:py-32 px-6 md:px-12 lg:px-24 bg-black relative z-20">
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-12 lg:gap-16 items-center">

          {/* Photo */}
          <div className="w-full max-w-sm mx-auto lg:mx-0 lg:w-1/2">
            <motion.div
          ...
          <div className="w-full lg:w-1/2">
            <TextReveal text="ME, MYSELF" className="font-serif text-3xl md:text-5xl lg:text-6xl text-white mb-8 md:mb-12" />
            <div className="space-y-5 text-base md:text-lg text-white/70 font-light leading-relaxed">
              <p>
      ...
      {/* ── Contact Section ── */}
      <section id="contact" className="py-20 md:py-32 px-6 md:px-12 lg:px-24 bg-dark-gray relative z-20 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto text-center relative z-10">
          <motion.div
            ...
            transition={{ duration: 0.8 }}
          >
            <h2 className="font-serif text-4xl sm:text-5xl md:text-7xl lg:text-8xl text-white mb-6 md:mb-8 leading-tight">
              Let's create something{' '}
              <span className="text-gold italic">extraordinary</span>.
            </h2>
            <p className="text-base md:text-xl text-white/60 mb-10 md:mb-16 max-w-2xl mx-auto font-light">
              Always open to discussing new projects, creative ideas or opportunities to be part of your visions.
            </p>

            <div className="flex flex-col sm:flex-row justify-center items-center gap-6 md:gap-8">
              <MagneticButton href="mailto:sharathsilangari@gmail.com" className="text-base md:text-lg px-8 md:px-12 py-4 md:py-6">
                Get in touch
              </MagneticButton>
              <a
        ...
        <div className="mt-20 md:mt-32 pt-8 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-4 text-xs md:text-sm text-white/40 tracking-widest">
